...
```Back-end``` ```JavaScript``` ```ES6``` ```Redis``` ```NodeJS``` ```ExpressJS```
```Kue```
...
## ```2. Node Redis client and basic operations (mandatory)```
...
## ```3. Node Redis client and async operations (mandatory)```
...
## ```4. Node Redis client and advanced operations (mandatory)```
...
## ```5. Node Redis client publisher and subscriber (mandatory)```
...
## ```6. Create the Job creator (mandatory)```
...
## ```7. Create the Job processor (mandatory)```
...
## ```8. Track progress and errors with Kue: Create the Job creator (mandatory)```
...
## ```9. Track progress and errors with Kue: Create the Job processor (mandatory)```
...
>- GitHub repository: ```alx-backend```
>- Directory: ```0x03-queuing_system_in_js```
>- File: 7-job_p```rocessor.js```
 
## ```10. Writing the job creation function (mandatory)```
...
## ```11. Writing the test for job creation (mandatory)```
